package eu.dissco.dataexporter.security;

import static org.assertj.core.api.Assertions.assertThat;

import eu.dissco.dataexporter.properties.SecurityProperties;
...
class JwtAuthConverterTest {
  ...
  void testTokenRoles() {
    ...
    var jwt = new Jwt("SomeRandomStringWithTheFullValue", Instant.now(), Instant.now(),
        ...
        Map.of("sub", "adf294ba-bb03-4962-8042-a37f1648458e",
            ...
            "resource_access", Map.of("dissco-data-exporter-backend", Map.of("roles", List.of("dissco-data-exporter-backend")))));
  ...
  void testTokenMissingPropertyRoles() {
    ...
    var jwt = new Jwt("SomeRandomStringWithTheFullValue", Instant.now(), Instant.now(),
        Map.of("kid", "SomeRandom", "typ", "JWT", "alg", "RS256"),
        Map.of("sub", "adf294ba-bb03-4962-8042-a37f1648458e",
            "resource_access", Map.of("orchestration-service", Map.of("roles", List.of("dissco-data-exporter-backend")))));
